...
function Profile() {
  ...
  return (
    <div>
      <Nav />
      <div className=" container py-8 mx-auto shadow-[0_0_5px_lightgray] mt-[15vh] rounded-lg p-4 my-5">
        <div className="flex items-center  gap-2">
          <Image width={80} src={profile} />
          <div>
            <p className="text-2xl text-[#0775c6] font-semibold">{isLogin.username}</p>
            <p className="text-gray-500">{isLogin.email}</p>
          </div>
        </div>
        <div className="flex gap-11">
          <div className="flex-1">
            ...
            <p className="text-1xl my-2">
              {isLogin.username} here,A Social Media Influencer/Software Engineer. By day, I
            ...
            <div className="flex item-center my-4 gap-4">
              ...
              <FaEnvelope className="text-[#0775c6]" size={40} />
            </div>
          </div>
            ...
            {myBlogs.map((blog) => {
              return (
                ...
                <Link href={`/profile/blogs/${blog.id}`}>
                  <div className="flex w-[100%] items-center gap-[em]">
                    <div className="w-[40%] h-[17vh] rounded-lg">
                      <img
                    ...
                    <div className="w-[80%] h-[17vh]">
                      <h3
                        dangerouslySetInnerHTML={{
                          __html: `${blog.blog_title.substr(0, 150)}...`,
                        }}
                        className="text-1xl font-bold"
                      ></h3>
                      <p
                        dangerouslySetInnerHTML={{
                          __html: `${blog.blog_post.substr(0, 150)}...`,
                        }}
                      ></p>
                    </div>
                  </div>
